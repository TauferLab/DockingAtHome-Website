...
require_once($_SERVER['DOCUMENT_ROOT']."/../inc/team_types.inc");
...
function show_list($list) {
    ...
    foreach ($list as $team) {
        ...
        echo "<tr class=bordered>
            <td class=shaded valign=top><a href=/community/team/display.php?teamid=$team->id>$team->name</a></td>
...
function search($params) {
    ...
    if (sizeof($list) == 0) {
        echo "
            ...
            Try another search.
            <p>
            Or you can <a href=/community/team/create_form.php>create a new team</a>.
            <p>
        ";
...
if (isset($_GET['submit'])) {
    ...
    display_page_top("Team search results");
    search($params);
} else {
    display_page_top("Find a team", 'document.form.keywords.focus()');
    echo "
