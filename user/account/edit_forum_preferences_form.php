...
display_page_top("Community preferences");
...
start_table();
echo "<form method=\"post\" action=\"/account/edit_forum_preferences_action.php\" enctype=\"multipart/form-data\">";
...
row2("Or click here to reset preferences to the defaults",
    "<form method=\"post\" action=\"/account/edit_forum_preferences_action.php\"><input type=\"submit\" value=\"Reset\"><input type=\"hidden\" name=\"action\" value=\"reset_confirm\"></form>"
);
end_table();
display_page_bottom();
