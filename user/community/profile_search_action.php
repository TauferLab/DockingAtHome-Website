...
function show_search_profile_link($profile, $n) {
...
display_page_top("Profile search results");
...
foreach($profiles as $profile) {
    show_search_profile_link($profile, $n+$offset+1);
    $n += 1;
}
echo "</table>";
...
if ($n==$count) {
    ...
    $offset += $count;
    echo "
        <a href=/community/profile_search_action.php?search_string=$s&offset=$offset>Next $count</a>
    ";
