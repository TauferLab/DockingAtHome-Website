...
require_once($_SERVER['DOCUMENT_ROOT']."/../inc/image.inc"); // Avatar scaling
...
if (post_str("action", true)=="reset_confirm"){
    display_page_top("Confirm reset");
    echo "This action will erase any changes you have made
        ...
        <p>
        <form action=/account/edit_forum_preferences_action.php method=post>
...
if (post_str("action", true)=="reset"){
    ...
    Header("Location: /account/edit_forum_preferences_form.php");
    exit;
}
