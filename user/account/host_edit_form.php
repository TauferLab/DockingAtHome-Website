...
display_page_top("Merge computers");

$t = time_str($host->create_time);
echo "
    Sometimes BOINC assigns separate identities to the same computer by mistake.
    You can correct this by merging old identities with the newest one.
    <form name=blah action=/account/host_edit_action.php>
...
if ($nhosts == 1) {
    ...
    if (!$detail) {
        echo "<p><a href=/account/host_edit_form.php?hostid=$hostid&detail=1>Show details</a>
        ";
    }
    display_page_bottom();
    exit();
